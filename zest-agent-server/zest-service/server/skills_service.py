"""Skills service for Zest Agent Server.
...
Skill Sources:
- Public skills: GitHub Zest/skills repository
- User skills: ~/.Zest/skills/ and ~/.Zest/microagents/
- Project skills: {workspace}/.Zest/skills/, .cursorrules, agents.md
- Organization skills: {org}/.Zest or {org}/Zest-config
...
from common.utils import sanitized_env
...
def load_org_skills_from_url(
    ...
    if working_dir:
        ...
        temp_dir = Path(tempfile.gettempdir()) / f"Zest_org_skills_{org_name}"
...
def load_all_skills(
    ...
    2. Public skills - From GitHub Zest/skills repository
    3. User skills - From ~/.Zest/skills/
    4. Organization skills - From {org}/.Zest or equivalent
    5. Project skills (highest) - From {workspace}/.Zest/skills/

    Args:
        load_public: Whether to load public skills from Zest/skills repo.
        load_user: Whether to load user skills from ~/.Zest/skills/.
...
def sync_public_skills() -> tuple[bool, str]:
    ...
    the latest skills from the Zest/skills repository.

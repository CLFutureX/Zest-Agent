"""Skills router for Zest Agent Server.
...
from server.skills_service import (
    ExposedUrlData,
    load_all_skills,
    sync_public_skills,
)
...
class SkillsRequest(BaseModel):
    ...
    load_public: bool = Field(
        default=True, description="Load public skills from Zest/skills repo"
    )
    load_user: bool = Field(
        default=True, description="Load user skills from ~/.Zest/skills/"
    )

...
from sdk.llm.exceptions import LLMResponseError
from sdk.llm.utils.metrics import Metrics


class ZestJSONEncoder(json.JSONEncoder):
...
def dumps(obj, **kwargs):
    ...
    if "cls" not in encoder_kwargs:
        encoder_kwargs["cls"] = ZestJSONEncoder

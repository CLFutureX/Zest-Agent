...
from sdk.event.base import N_CHAR_PREVIEW, LLMConvertibleEvent
from common.event.types import SourceType, ToolCallID,EventID
from sdk.llm import (
    Message,
    MessageToolCall,
    ReasoningItemModel,
...
from sdk.tool.schema import Action
...
class ActionEvent(LLMConvertibleEvent):
    ...
    # 始终要注意，ActionEvent作为一个行为事件容器，最终下一次还是会将llm之前的回复带给llm，而不是增加action-- 刚才看event的内容发现了重复，所以有此分析。
    # 其次，需要注意的是，在摘要时，并不会将

...
from sdk.context.skills import Skill
...
from sdk.plugin.fetch import fetch_plugin
...
class Plugin(BaseModel):
    ...
    def add_skills_to(
        ...
        existing_skills = agent_context_spec.skills if agent_context_spec else []
        ...
        if agent_context_spec:
            return agent_context_spec.model_copy(update={"skills": merged_skills})
        return AgentContextSpec(skills=merged_skills)
    ...
    def fetch(
        ...
        Args:
            ...
            cache_dir: Directory for caching. Defaults to ~/.Zest/cache/plugins/

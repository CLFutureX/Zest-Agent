...
from sdk.git.cached_repo import GitHelper, try_cached_clone_or_update
from sdk.git.utils import extract_repo_name, is_git_url, normalize_git_url
from common.logger import get_logger


logger = get_logger(__name__)

DEFAULT_CACHE_DIR = Path.home() / ".Zest" / "cache" / "plugins"
...
def get_cache_path(source: str, cache_dir: Path | None = None) -> Path:
    ...
    Args:
        ...
        cache_dir: Base cache directory. Defaults to ~/.Zest/cache/plugins/

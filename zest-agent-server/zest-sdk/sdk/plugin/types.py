...
#: See https://github.com/Zest/software-agent-sdk/issues/1745 for LSP support.
...
#: See sdk.hooks.HookConfig for the full structure.
...
class CommandDefinition(BaseModel):
    ...
    def to_skill(self, plugin_name: str) -> Skill:
        ...
        """
        from sdk.context.skills import Skill
        from sdk.context.skills.trigger import KeywordTrigger
...
class MarketplacePluginEntry(BaseModel):
    ...
    hooks: str | HooksConfigDict | None = Field(
        ...
        "See sdk.hooks.HookConfig for the expected structure.",
    )

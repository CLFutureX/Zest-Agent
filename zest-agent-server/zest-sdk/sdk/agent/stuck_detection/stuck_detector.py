...
from sdk.agent.stuck_detection.types import StuckDetectionThresholds
...
class StuckDetector:
    ...
    def is_stuck(self, events: Sequence[Event]) -> bool:
        ...
        """
        events = list(events[-MAX_EVENTS_TO_SCAN_FOR_STUCK_DETECTION:])
    ...
    def _is_stuck_context_window_error(self, _events: list[Event]) -> bool:
        ...
        events between them.
        """
        # TODO: blocked by https://github.com/Zest/agent-sdk/issues/282
        return False

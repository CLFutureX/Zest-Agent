...
with Zest-native types, eliminating the need for consumers to work directly
with LiteLLM types.
"""
...
from sdk.llm.message import Message
from sdk.llm.utils.metrics import MetricsSnapshot
...
class LLMResponse(BaseModel):
    ...
    only Zest-native types to consumers while preserving access to the
    raw LiteLLM response for internal use.

    Attributes:
        message: The completion message converted to Zest Message type

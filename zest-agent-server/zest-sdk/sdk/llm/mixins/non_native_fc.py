...
from sdk.llm.exceptions import LLMNoResponseError
from sdk.llm.mixins.fn_call_converter import (
    STOP_WORDS,
    convert_fncall_messages_to_non_fncall_messages,
    convert_non_fncall_messages_to_fncall_messages,
)
from sdk.llm.utils.model_features import get_features
...
class NonNativeToolCallingMixin:
    ...
    def pre_request_prompt_mock(
        ...
        add_iclex = not any(
            s in self.model for s in ("Zest-lm", "devstral", "nemotron")
        )

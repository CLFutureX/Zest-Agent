...
from sdk.git.git_changes import get_git_changes
from sdk.git.git_diff import get_git_diff
from sdk.git.models import GitChange, GitDiff
from common.logger import get_logger
from common.utils.command import execute_command
...
class LocalWorkspace(BaseWorkspace):
    ...
    def execute_command(
        ...
        # 通过shell窗口执行命令并读取输出或错误信息作为result

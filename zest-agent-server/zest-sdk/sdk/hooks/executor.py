...
from sdk.hooks.config import HookDefinition
from sdk.hooks.types import HookDecision, HookEvent
...
class HookExecutor:
    ...
    def execute(
        ...
        hook_env["Zest_PROJECT_DIR"] = self.working_dir
        hook_env["Zest_SESSION_ID"] = event.session_id or ""
        hook_env["Zest_EVENT_TYPE"] = event.event_type
        if event.tool_name:
            hook_env["Zest_TOOL_NAME"] = event.tool_name

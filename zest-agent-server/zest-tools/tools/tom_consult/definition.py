...
from common.storage.file_store import LocalFileStore
from sdk.llm import ImageContent, TextContent
from sdk.tool import Action, Observation, ToolDefinition, register_tool
...
class TomConsultTool(ToolDefinition[ConsultTomAction, ConsultTomObservation]):
    ...
    def create(
        ...
        file_store = LocalFileStore(root="~/.Zest")
...
register_tool(TomConsultTool.tool_name, TomConsultTool)
register_tool(SleeptimeComputeTool.tool_name, SleeptimeComputeTool)

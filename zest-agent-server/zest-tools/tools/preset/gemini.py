"""Gemini preset configuration for Zest agents.
...
def get_gemini_tools(
    ...
    tools = [
        ...
        Tool(name=ReadFileTool.tool_name),
        Tool(name=WriteFileTool.tool_name),
        Tool(name=EditTool.tool_name),
        Tool(name=ListDirectoryTool.tool_name),

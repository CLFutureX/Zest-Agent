...
from sdk.conversation.base import BaseConversation, ConversationStateProtocol
...
from sdk.conversation.exceptions import (
    ConversationRunError,
    WebSocketConnectionError,
)
from sdk.conversation.secret_registry import SecretValue
from sdk.conversation.state import ConversationExecutionStatus
...
from sdk.logger import DEBUG, get_logger
...
from sdk.workspace import LocalWorkspace, RemoteWorkspace
    ...
    def __init__(
        ...
        **_: object,
        ...
        if should_create:
            ...
            from sdk.tool.registry import get_tool_module_qualnames
    ...
    def run(
        ...
        try:
            resp = _send_request(
                ...
                timeout=300,  # Short timeout for trigger request
            )

...
class EventConsumer(ABC):
    ...
    def match_event(
        self,
        event_conversation_id: uuid.UUID | str | None,
        event_agent_id: str | uuid.UUID | None,
    ) -> bool:
...
class EventCenter:
    ...
    def clear_conversation(self, conversation_id: uuid.UUID | str) -> None:
    ...
    def clear_agent(
        self, conversation_id: uuid.UUID | str, agent_id: str | uuid.UUID
    ) -> None:
        """清空指定Agent的消费者
